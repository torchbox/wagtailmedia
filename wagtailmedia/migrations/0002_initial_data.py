...
def add_media_permissions_to_admin_groups(apps, schema_editor):
    ...
    for group in Group.objects.filter(name__in=['Editors', 'Moderators']):
        group.permissions.add(add_media_permission, change_media_permission, delete_media_permission)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_media_permissions_to_admin_groups, remove_media_permissions),
    ]
